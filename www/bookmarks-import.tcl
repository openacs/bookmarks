...
set context [bm_context_bar_args [list [list "bookmark-add-import?[export_url_vars viewed_user_id return_url]" "Add/Import Bookmarks"] $page_title] $viewed_user_id]
